...
/**
 * CustomsDeclarationPaginatedList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomsDeclarationPaginatedList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomsDeclarationPaginatedList';
    ...
    protected static $openAPITypes = [
        'next' => 'string',
        'previous' => 'string',
        'results' => '\OpenAPI\Client\Model\CustomsDeclaration[]'
    ];
    ...
    */
     ...
     * Sets results
     *
     * @param \OpenAPI\Client\Model\CustomsDeclaration[]|null $results results
     *
     * @return self
     */
