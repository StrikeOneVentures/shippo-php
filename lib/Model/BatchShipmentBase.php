...
/**
 * BatchShipmentBase Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BatchShipmentBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BatchShipmentBase';
    ...
    */
    ...
    public function setMetadata($metadata)
    {
        ...
        if ((mb_strlen($metadata) > 100)) {
            throw new \InvalidArgumentException('invalid length for $metadata when calling BatchShipmentBase., must be smaller than or equal to 100.');
        }
