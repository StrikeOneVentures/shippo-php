...
/**
 * BatchShipmentCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BatchShipmentCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BatchShipmentCreateRequest';
    ...
    */
    ...
    public function setMetadata($metadata)
    {
        ...
        if ((mb_strlen($metadata) > 100)) {
            throw new \InvalidArgumentException('invalid length for $metadata when calling BatchShipmentCreateRequest., must be smaller than or equal to 100.');
        }
