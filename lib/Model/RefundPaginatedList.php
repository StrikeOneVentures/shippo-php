...
/**
 * RefundPaginatedList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RefundPaginatedList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RefundPaginatedList';
    ...
    protected static $openAPITypes = [
        'next' => 'string',
        'previous' => 'string',
        'results' => '\OpenAPI\Client\Model\Refund[]'
    ];
    ...
    */
     ...
     * Sets results
     *
     * @param \OpenAPI\Client\Model\Refund[]|null $results results
     *
     * @return self
     */
