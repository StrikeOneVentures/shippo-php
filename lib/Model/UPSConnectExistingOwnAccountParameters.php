...
/**
 * UPSConnectExistingOwnAccountParameters Class Doc Comment
 *
 * @category Class
 ...
 */
class UPSConnectExistingOwnAccountParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UPSConnectExistingOwnAccountParameters';
    ...
    */
    ...
    public function setBillingAddressCountryIso2($billing_address_country_iso2)
    {
        ...
        if ((mb_strlen($billing_address_country_iso2) > 2)) {
            throw new \InvalidArgumentException('invalid length for $billing_address_country_iso2 when calling UPSConnectExistingOwnAccountParameters., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($billing_address_country_iso2) < 2)) {
            throw new \InvalidArgumentException('invalid length for $billing_address_country_iso2 when calling UPSConnectExistingOwnAccountParameters., must be bigger than or equal to 2.');
        }
    ...
    public function setBillingAddressState($billing_address_state)
    {
        ...
        if ((mb_strlen($billing_address_state) > 2)) {
            throw new \InvalidArgumentException('invalid length for $billing_address_state when calling UPSConnectExistingOwnAccountParameters., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($billing_address_state) < 2)) {
            throw new \InvalidArgumentException('invalid length for $billing_address_state when calling UPSConnectExistingOwnAccountParameters., must be bigger than or equal to 2.');
        }
    ...
    public function setBillingAddressZip($billing_address_zip)
    {
        ...
        if ((mb_strlen($billing_address_zip) > 5)) {
            throw new \InvalidArgumentException('invalid length for $billing_address_zip when calling UPSConnectExistingOwnAccountParameters., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($billing_address_zip) < 5)) {
            throw new \InvalidArgumentException('invalid length for $billing_address_zip when calling UPSConnectExistingOwnAccountParameters., must be bigger than or equal to 5.');
        }
    ...
    public function setCollecCountryIso2($collec_country_iso2)
    {
        ...
        if ((mb_strlen($collec_country_iso2) > 2)) {
            throw new \InvalidArgumentException('invalid length for $collec_country_iso2 when calling UPSConnectExistingOwnAccountParameters., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($collec_country_iso2) < 2)) {
            throw new \InvalidArgumentException('invalid length for $collec_country_iso2 when calling UPSConnectExistingOwnAccountParameters., must be bigger than or equal to 2.');
        }
    ...
    public function setCollecZip($collec_zip)
    {
        ...
        if ((mb_strlen($collec_zip) > 5)) {
            throw new \InvalidArgumentException('invalid length for $collec_zip when calling UPSConnectExistingOwnAccountParameters., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($collec_zip) < 5)) {
            throw new \InvalidArgumentException('invalid length for $collec_zip when calling UPSConnectExistingOwnAccountParameters., must be bigger than or equal to 5.');
        }
    ...
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling UPSConnectExistingOwnAccountParameters., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling UPSConnectExistingOwnAccountParameters., must be bigger than or equal to 3.');
        }
    ...
    public function setInvoiceControlid($invoice_controlid)
    {
        ...
        if ((mb_strlen($invoice_controlid) > 4)) {
            throw new \InvalidArgumentException('invalid length for $invoice_controlid when calling UPSConnectExistingOwnAccountParameters., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($invoice_controlid) < 4)) {
            throw new \InvalidArgumentException('invalid length for $invoice_controlid when calling UPSConnectExistingOwnAccountParameters., must be bigger than or equal to 4.');
        }
    ...
    public function setInvoiceNumber($invoice_number)
    {
        ...
        if ((mb_strlen($invoice_number) > 15)) {
            throw new \InvalidArgumentException('invalid length for $invoice_number when calling UPSConnectExistingOwnAccountParameters., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($invoice_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $invoice_number when calling UPSConnectExistingOwnAccountParameters., must be bigger than or equal to 1.');
        }
