 ...
 */
class Alcohol implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Alcohol';
    ...
    public const RECIPIENT_TYPE_LICENSEE = 'licensee';
    public const RECIPIENT_TYPE_CONSUMER = 'consumer';
    ...
    {
        return [
            self::RECIPIENT_TYPE_LICENSEE,
            self::RECIPIENT_TYPE_CONSUMER,
        ];
    }
    ...
    */
     ...
     *
     * @param bool|null $contains_alcohol Mandatory for Fedex and UPS. Specifies that the package contains Alcohol.
     *
     * @return self
     */
     ...
     * Sets recipient_type
     *
     * @param string|null $recipient_type Mandatory for Fedex only. License type of the recipient of the Alcohol Package.
     *
     * @return self
     */
