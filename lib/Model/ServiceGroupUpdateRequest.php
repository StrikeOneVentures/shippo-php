...
/**
 * ServiceGroupUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServiceGroupUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServiceGroupUpdateRequest';
    ...
    */
     ...
     * Sets description
     *
     * @param string $description Description for the service group
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Name for the service group that will be shown to customers in the response
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\ServiceGroupTypeEnum
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\ServiceGroupTypeEnum $type type
     *
     * @return self
     */
     ...
     * Sets is_active
     *
     * @param bool $is_active True if the service group is enabled, false otherwise.
     *
     * @return self
     */
