...
/**
 * UserParcelTemplateCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserParcelTemplateCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserParcelTemplateCreateRequest';
    ...
    */
     ...
     * Sets template
     *
     * @param string|null $template The object representing the carrier parcel template
     *
     * @return self
     */
