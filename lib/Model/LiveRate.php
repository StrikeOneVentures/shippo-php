 ...
 */
class LiveRate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LiveRate';
    ...
    */
     ...
     * Sets estimated_days
     *
     * @param int|null $estimated_days The estimated days in transit of the rate that powers the shipping option, if available.
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title The name of the service group being returned
     *
     * @return self
     */
