...
/**
 * AddressImporter Class Doc Comment
 *
 * @category Class
 ...
 */
class AddressImporter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddressImporter';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name First and Last Name of the addressee
     *
     * @return self
     */
     ...
     * Sets street1
     *
     * @param string|null $street1 First street line, 35 character limit. Usually street number and street name (except for DHL Germany, see street_no).
     *
     * @return self
     */
     ...
     * Sets city
     *
     * @param string|null $city Name of a city
     *
     * @return self
     */
     ...
     * Sets zip
     *
     * @param string|null $zip Postal code of an Address.
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country Example: `US` or `DE`. All accepted values can be found on the  <a href=\"http://www.iso.org/\" target=\"blank\">Official ISO Website</a>. Sending a country is always required.
     *
     * @return self
     */
     ...
     * Sets is_residential
     *
     * @param bool|null $is_residential Indicates whether the address provided is a residential address or not.
     *
     * @return self
     */
